...
const shortMessageElement = ref<HTMLElement | null>(null);
const timeZoneElement = ref<HTMLElement | null>(null);
...
.styled-footer {
  ...
  .footer-vertical {
    ...
    width: 100%;
    border-top: 1px solid rgba(colors.color(lightest-background), 0.5);
    padding: 1em;
  }
